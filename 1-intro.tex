...
Hierarchical algorithms, nested parallelism, and dynamic work creation are common patterns in parallel programming that can be difficult to express using the fork-join model~\cite{ayguadeProposalTaskParallelism2008}~\cite{duranProposalDependenciesOpenMP2009}. Task-based parallel programming models were introduced to address these limitations by providing more flexible parallelism expression.
